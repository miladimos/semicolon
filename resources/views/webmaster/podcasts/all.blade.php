            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{  asset('storage/'.$podcast->thumbnail_path) }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $podcast->title }}</td>
                    <td class="product-name">{{ $podcast->slug }}</td>
                    <td class="product-category">{{ $podcast->categories ?? '---' }}</td>
                    <td class="product-category">{{ $podcast->downloadCount ?? '' }}</td>
                    <td class="product-category">{{ $podcast->user->username ?? '' }}</td>
                    <td class="product-name">{{ $podcast->created_at }}</td>
                    <td>
                        @if($podcast->active)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.podcasts.edit', $podcast->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.podcasts.show', $podcast->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
