...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">ثبت سطح دسترسی جدید</a></li>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form action="{{ route('webmaster.permissions.store') }}" method="POST" novalidate>
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" placeholder="عنوان فارسی"
                                                    value="{{ old('fa_name') }}" name="fa_name" required
                                                    data-validation-required-message="This text field is required">
                                            </div>
                                        </div>
