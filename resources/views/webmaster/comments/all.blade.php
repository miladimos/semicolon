...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">نظرات</a>
    </li>
@endsection
        ...
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-category">{{ $comment->user->username ?? '' }}</td>
                    <td class="product-category">{{ $comment->comment ?? '' }}</td>
                    <td class="product-category">---</td>
                    <td>
                        @if($comment->approved)
                        <div class="chip chip-primary">
                            <div class="chip-body">
                                <div class="chip-text">پذیرفته شده</div>
                            </div>
                        </div>
                        @else
                        <div class="chip chip-danger">
                            <div class="chip-body">
                                <div class="chip-text">پذیرفته نشده</div>
                            </div>
                        </div>
                        @endif
                    </td>
                    <td class="product-action">
                        <a href="{{ route('webmaster.comments.edit', $comment->uuid) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.comments.show', $comment->uuid) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
