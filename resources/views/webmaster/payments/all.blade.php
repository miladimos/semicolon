...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">پرداخت ها</a>
    </li>
@endsection
        ...
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-name">{{ $payment->title ?? ''}}</td>
                    <td class="product-name">{{ $payment->amount ?? ''}}</td>
                    <td class="product-name">{{ $payment->user->label ?? ''}}</td>
                    <td class="product-name">{{ $payment->created_at ?? ''}}</td>
                    <td>
                        @if($payment->payment)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.payments.edit', $payment->uuid) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.payments.show', $payment->uuid) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
