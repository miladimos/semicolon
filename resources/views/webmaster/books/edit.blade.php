...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">ویرایش کتاب</a>
    </li>
@endsection
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
                                ...
                                <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">ویرایش کتاب</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form action="{{ route('webmaster.books.update', $book->uuid) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" placeholder="زبان کتاب" name="lang"
                                                    value="{{ old('lang') ?? $book->lang }}" required
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" placeholder="شابک کتاب"
                                                    name="shabak" value="{{ old('shabak') ?? $book->shabak }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="tags[]" multiple="multiple">
                                                @foreach ($tags as $tag)
                                                    <option value="{{ $tag->id }}" @if (in_array($tag->id, $book->tags->pluck('id')->toArray())) selected @endif>
                                                        {{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <fieldset class="form-group">
                                            ...
                                            <img src="{{ $book->thumbnail_path }}" alt="{{ $book->title }}" width="200">
                                        </fieldset>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" placeholder="نویسنده" name="authors"
                                                    value="{{ old('authors') ?? $book->authors }}" required
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="number" class="form-control" placeholder="تعداد صفحات"
                                                    name="page_count" value="{{ old('page_count') ?? $book->page_count }}" required
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="imauthor" id="imauthor"
                                                    class="custom-control-input" @if($book->author_id === auth()->id()) checked @endif>
                                            ...
                                            <select class="form-control select2" name="author_id">
                                                ...
                                                @foreach ($authors as $author)
                                                    <option value="{{ $author->id }}" @if($book->author->id === $author->id) selected @endif>{{ $author->username }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" placeholder="نویسنده" name="active" id="active"
                                                    class="custom-control-input" @if($book->active) checked @endif>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <textarea class="form-control" name="description" id="description" required
                                                    ...
                                                    rows="8">{{ old('description') ?? $book->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <textarea class="form-control" name="body" id="body" required
                                                    data-validation-required-message="فیلد توضیحات ضروری می باشد"
                                                    rows="8">{{ old('body') ?? $book->body }}</textarea>
                                            </div>
                                        </div>
                                    </div>
