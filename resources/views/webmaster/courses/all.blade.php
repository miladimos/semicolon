                    ...
                    @foreach ($courses as $course)
                        <tr>
                            ...
                            <td class="product-img">
                                <img src="{{ $course->thumbnail_path }}" alt="Img placeholder">
                            </td>
                            <td class="product-name">{{ $course->title }}</td>
                            <td class="product-name">{{ $course->slug }}</td>
                            <td class="product-category">{{ $course->episodes()->count() ?? '---' }}</td>
                            <td class="product-category">{{ $course->categories()->pluck('name')->join(', ') ?? '---' }}
                            </td>
                            <td class="product-category">{{ $course->type->title ?? '' }}</td>
                            <td class="product-category">{{ $course->price ?? '' }}</td>
                            <td class="product-category">{{ jdate($course->created_at)->ago() ?? '' }}</td>
                            <td>
                                @if ($course->active)
                            ...
                            <td class="product-action">
                                <a href="{{ route('webmaster.courses.edit', $course->uuid) }}"><span
                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                <a href="{{ route('webmaster.courses.show', $course->uuid) }}"><span
                                        class="action-edit"><i class="feather icon-user"></i></span></a>
