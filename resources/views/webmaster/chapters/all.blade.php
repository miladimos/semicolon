...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">سرفصل ها</a>
    </li>
@endsection
        ...
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-category">{{ $chapter->title ?? '' }}</td>
                    <td class="product-category">{{ $chapter->course->title ?? '' }}</td>
                    <td class="product-category">{{ $chapter->number ?? '' }}</td>
                    <td>
                        @if($chapter->active)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.chapters.edit', $chapter->uuid) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.chapters.show', $chapter->uuid) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
