        ...
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-category">{{ $role->fa_name ?? '' }}</td>
                    <td class="product-category">{{ $role->description ?? '' }}</td>
                    <td>
                        @if($role->active)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.roles.edit', $role->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.roles.show', $role->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
