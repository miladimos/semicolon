            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{  asset('storage/'.$book->thumbnail_path) }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $book->title }}</td>
                    <td class="product-category">{{ $book->categories ?? '---' }}</td>
                    <td class="product-category">{{ $book->downloadCount ?? '' }}</td>
                    <td class="product-category">{{ $book->lang ?? '' }}</td>
                    <td class="product-category">{{ $book->author ?? '' }}</td>
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.books.edit', $book->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.books.show', $book->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
