...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">ویرایش نقش</a>
    </li>
@endsection
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
                                ...
                                <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">ویرایش نقش</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form action="{{ route('webmaster.roles.update', $role) }}" method="POST" novalidate>
                                @csrf
                                @method('put')
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" name="fa_name"
                                                    placeholder="نام فارسی" value="{{ old('fa_name') ?? $role->fa_name }}"
                                                    required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="permissions[]" multiple="multiple">
                                                @foreach ($permissions as $permission)
                                                    <option value="{{ $permission->id }}" @if (in_array(
            $permission->id,
            $role->permissions()->pluck('id')->toArray(),
        )) selected @endif>{{ $permission->name }},
                                        ...
                                        {{-- <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" placeholder="نویسنده" name="active" id="active"
                                                    class="custom-control-input" @if ($role->active)
                                                    checked
                                                    @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <textarea class="form-control" name="description" id="description" required
                                                ...
                                                rows="8">{{ old('description') ?? $role->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
