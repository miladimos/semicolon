            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{  asset('storage/'.$episode->thumbnail_path) }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $episode->title }}</td>
                    <td class="product-name">{{ $episode->slug }}</td>
                    <td class="product-name">{{ $episode->course->title }}</td>
                    <td class="product-name">{{ $episode->chapter->title ?? '' }}</td>
                    <td class="product-name">{{ $episode->type ?? '' }}</td>
                    <td class="product-name">{{ $episode->time ?? ''}}</td>
                    <td class="product-name">{{ $episode->created_at }}</td>
                    <td>
                        @if($episode->active)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.episodes.edit', $episode->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.episodes.show', $episode->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
