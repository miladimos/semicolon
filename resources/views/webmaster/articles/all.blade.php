...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">مقالات</a>
    </li>
@endsection
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{  asset('storage/'.$article->thumbnail_path) }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $article->title }}</td>
                    <td class="product-name">{{ $article->slug }}</td>
                    <td class="product-category">{{ $article->categories()->pluck('name')->join(', ') ?? '---' }}</td>
                    <td class="product-category">{{ $article->viewCount ?? '' }}</td>
                    <td class="product-category">{{ $article->author()->username ?? '' }}</td>
                    <td class="product-category">{{ jdate($article->published_at)->format("%A, %d %B %y") ?? '' }}</td>
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.articles.edit', $article->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.articles.show', $article->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
