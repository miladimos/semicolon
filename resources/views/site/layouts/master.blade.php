                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_01.jpg') }}" alt="" class="img-fluid">
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_02.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_03.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Beauty</span>
                                                                </a>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_04.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Spa</span>
                                                                </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_05.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_06.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_07.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Fashion</span>
                                                                </a>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_08.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_09.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_11.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_12.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_13.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Tourism</span>
                                                                </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_14.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_15.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_16.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_17.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_18.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_19.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_20.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="single.html" title="">
                                                                    <img src="{{ asset('/statics/site/upload/menu_21.jpg') }}" alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                            ...
                            <div class="list-group">
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_01.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_02.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 last-item justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_03.jpg') }}" alt="" class="img-fluid float-left">
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            <div class="list-group">
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_04.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_07.jpg') }}" alt="" class="img-fluid float-left">
                                ...
                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 last-item justify-content-between">
                                        <img src="{{ asset('/statics/site/upload/blog_square_06.jpg') }}" alt="" class="img-fluid float-left">
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="widget">
                        <div class="footer-text text-center">
                            <a href="index.html"><img src="{{ asset('/statics/site/images/flogo.png') }}" alt="" class="img-fluid"></a>
...
<script src="{{ asset('/statics/site/js/tether.min.js') }}"></script>
