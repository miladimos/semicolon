        ...
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-category">{{ $faq->answer }}</td>
                    <td>
                    ...
                    <td class="product-price">{{ $faq->created_at }}</td>
                    <td class="product-action">
                        <a href="{{ route('webmaster.faqs.edit', $faq->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
