...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">تخفیف ها</a>
    </li>
@endsection
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{  asset('storage/'.$discount->thumbnail_path) }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $discount->title }}</td>
                    <td class="product-name">{{ $discount->for ?? '' }}</td>
                    <td class="product-name">{{ $discount->code ?? '' }}</td>
                    {{-- <td class="product-category">{{ $discount->courses->count() ? $discount->courses->pluck('title')->join(', ') : 'همه دوره ها'}}</td> --}}
                    <td class="product-category">{{ $discount->percent ?? '' }}</td>
                    <td class="product-category">{{ $discount->start_at ?? '' }}</td>
                    <td class="product-category">{{ $discount->end_at ?? '' }}</td>
                    <td class="product-category">{{ jdate($discount->created_at)->ago() ?? '' }}</td>
                    <td>
                        @if($discount->active)
                    ...
                    <td class="product-action">
                        <a href="{{ route('webmaster.discounts.edit', $discount->id) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.discounts.show', $discount->id) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
