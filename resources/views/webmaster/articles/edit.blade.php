...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">ویرایش مقاله</a>
    </li>
@endsection
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                        ...
                        <form action="{{  route('webmaster.books.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" placeholder="زبان کتاب" name="lang" value="{{  old('lang') }}" required data-validation-required-message="فیلد زبان ضروری می باشد">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <label>شابک</label>
                                            <input type="text" class="form-control" placeholder="شابک کتاب" name="shabak" value="{{  old('shabak')  }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="active">کتاب فعال و قابل مشاهده باشد</label>
                                        </div>
                                    </div>
                                </div>
