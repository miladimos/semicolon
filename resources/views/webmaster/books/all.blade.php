            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="{{ $book->thumbnail_path }}" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $book->title }}</td>
                    <td class="product-category">{{ $book->categories->pluck('name')->join(', ') ?? '---' }}</td>
                    <td class="product-category">{{ $book->downloadCount ?? '' }}</td>
                    <td class="product-category">{{ $book->lang ?? '' }}</td>
                    <td class="product-category">{{ $book->authors ?? '' }}</td>
                    <td class="product-category">{{ $book->publisher->title ?? '' }}</td>
                    <td class="product-category">{{ $book->page_count ?? '' }}</td>
                    <td>
                        @if($book->active)
                    ...
                    <td class="product-category">{{ jdate($book->created_at)->ago() }}</td>
                    <td class="product-action">
                        <a href="{{ route('webmaster.books.edit', $book->uuid) }}"><span class="action-edit"><i class="feather icon-edit"></i></span></a>
                        <a href="{{ route('webmaster.books.show', $book->uuid) }}"><span class="action-edit"><i class="feather icon-user"></i></span></a>
