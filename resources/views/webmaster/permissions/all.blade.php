...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">سطح دسترسی ها</a>
    </li>
@endsection
                ...
                <tbody>
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td class="product-name">{{ $permission->fa_name }}</td>
                            <td class="product-name">{{ $permission->description ?? '' }}</td>
                            <td class="product-name">{{ $permission->role->name ?? '---' }}</td>
                            {{-- <td>
                            ...
                            <td class="product-action">
                                <a href="{{ route('webmaster.permissions.edit', $permission->id) }}"><span
                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                <a href="{{ route('webmaster.permissions.show', $permission->id) }}"><span
