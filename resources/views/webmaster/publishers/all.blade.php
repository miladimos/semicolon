...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="#">انتشارات</a>
    </li>
@endsection
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product-img">
                        <img src="https://picsum.photos/536/354" alt="Img placeholder">
                    </td>
                    <td class="product-name">{{ $publisher->title }}</td>
                    <td class="product-category">{{ $publisher->description ?? '' }}</td>
                    <td>
                        @if($publisher->active)
